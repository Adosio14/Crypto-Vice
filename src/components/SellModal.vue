                ...
                <div v-if="formData.crypto && cryptoStore.prices[formData.crypto]?.bid" class="text-sm text-gray-400">
                    <p>
                        ...
                        <span class="font-bold text-[#fc9db9]">
                            ${{ cryptoStore.userCryptoBalance[formData.crypto] }}
                        </span>
                    </p>
                    <p>Precio actual: ${{ cryptoStore.prices[formData.crypto].bid.toLocaleString() }}</p>
                    <p>
                        Recibirás:
                        <span class="font-bold text-[#fc9db9]">
                            ${{ arsAmount.toLocaleString(undefined, { maximumFractionDigits: 2 }) }}
                        </span>
                    </p>
                </div>
